...
function onCreatePost()
	...
	setObjectCamera('UpperBar(With HUD)', 'Other')
	addLuaSprite('UpperBar(With HUD)', false)
setObjectOrder('UpperBar(With HUD)', getObjectOrder('camHUD') - 1)

    makeLuaSprite('LowerBar(With HUD)', 'empty', -110, 720)
	makeGraphic('LowerBar(With HUD)', 1500, 350, '000000')
	setObjectCamera('LowerBar(With HUD)', 'Other')
	addLuaSprite('LowerBar(With HUD)', false)
setObjectOrder('LowerBar(With HUD)', getObjectOrder('camHUD') - 1)
